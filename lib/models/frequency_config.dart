...
class FrequencyConfig {
  ...
  factory FrequencyConfig.fromString(String freq) {
    if (freq.startsWith('Кожні')) {
      ...
      return FrequencyConfig(type: FrequencyType.everyXDays, interval: interval);
      ...
      return FrequencyConfig(type: FrequencyType.timesPerPeriod, interval: interval, period: period);
    }
